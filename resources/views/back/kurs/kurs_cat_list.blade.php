            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  ...
                  <form action="{{route('kurs.cat_all_delete')}}" method="post">
                      @csrf
                      @method('DELETE')
                  <ul class="nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{route('kurs.cat_trashed')}}" class="card-category">
                    ...
                    <table class="table table-hover">
                      ...
                      @if(count($categories) ==0 )
                        ...
                        <tr>
                          ...
                          <td>{{$cat->k_u_date}}</td>
                          <td>
                            <a href="{{route('kurs.cat_edit', $cat->k_id)}}">
                            <i class="material-icons">edit</i>
                            </a>
                            <a href="{{route('kurs.cat_delete', $cat->k_id)}}">
