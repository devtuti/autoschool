...
<div class="col-md-12">
              <div class="card">
                ...
                @if($errors->any())
                  ...
                  @endforeach
                @endif
                  <form action="{{route('kurs.post_cat')}}" method="post">
                    @csrf
                  <div class="row">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function addRow(){
            var tr = '<tr>'+
            '<td><select name="kurs[]" class="form-control">@foreach($kurs as $k)<option value="{{$k->id}}">{{$k->kurs_name}}</option>@endforeach</select></td>'+
