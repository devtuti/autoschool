...
<div class="col-md-12">
              <div class="card">
                ...
                @if($errors->any())
                  ...
                  @endforeach
                @endif
                  <form action="{{route('kurs_lesson_edit_post', $lesson->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="bmd-label-floating"> Lesson Content...</label>
                        ...
                        <div class="input-group mb-3">
                            <input type="file" class="form-control" id="inputGroupFile03" name="les_video" value="{{$lesson->les_video}}">
                            
                            <video style="max-height:50px; max-width:50px;" controls poster="/lessons/{{$lesson->photo}}">
                                <source src="/les_video/{{$lesson->les_video}}" type="video/mp4">
                            </video>
                        </div>
