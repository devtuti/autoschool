...
<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Car Category edit</h4>
                ...
                @if($errors->any())
                  ...
                  @endforeach
                @endif
                  <form action="{{route('car_cat_edit_post', $cats->id)}}" method="post">
                    @csrf
                  <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Update car category</button>
