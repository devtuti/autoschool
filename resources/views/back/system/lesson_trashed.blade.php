            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  ...
                  <form action="{{route('lesson_trashed_delete')}}" method="post">
                      @csrf
                      @method('DELETE')
                  <ul class="nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{route('lesson')}}" class="card-category">
                        All lessons
                      </a>
                    </li>
                  </ul>
                      ...
                      <tbody>
                          ...
                          <div class="alert alert-warning">
                            ...
                            @else
                                ...
                                <td>
                                    <a href="{{route('lesson_restore', $lesson->l_id)}}">
                                    <i class="material-icons">settings_backup_restore</i>
                                    </a>
                                    <a href="{{route('lesson_destroy', $lesson->l_id)}}">
