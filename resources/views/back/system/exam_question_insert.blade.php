...
<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Exam question add</h4>
                ...
                @if($errors->any())
                  ...
                  @endforeach
                @endif
                  <form action="{{route('post_exam_question')}}" method="post" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function addRow(){
            ...
            '<td> <textarea class="form-control" rows="5" name="test_exp[]"></textarea></td>'+
