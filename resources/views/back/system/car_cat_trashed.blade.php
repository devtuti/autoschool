...
@section('title')
   Trashed Car Categories
@endsection
@section('css')
@endsection

@section('page_name')
    Trashed Car Category list
@endsection
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  ...
                  <form action="{{route('car_cat_trashed_delete')}}" method="post">
                      @csrf
                      @method('DELETE')
                  <ul class="nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{route('car_cat')}}" class="card-category">
                        All car categories
                      </a>
                    </li>
                    ...
                    <table class="table table-hover">
                      ...
                      @if(count($categories) ==0 )
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{route('car_cat_restore', $cat->id)}}">
                            <i class="material-icons">settings_backup_restore</i>
                            </a>
                            <a href="{{route('car_cat_destroy', $cat->id)}}">
